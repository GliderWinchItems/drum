##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [4.5.0-B34] date: [Tue Jan 14 14:45:31 EST 2025] 
##########################################################################################################################
...
#C_SOURCES += Ourtasks/levelwind_idx_v_struct.c
C_SOURCES += Ourtasks/levelwind_func_init.c
C_SOURCES += Ourtasks/paycnvt.c
C_SOURCES += Ourtasks/levelwind_items.c
C_SOURCES += Ourtasks/levelwind_switches.c
...
C_SOURCES += Ourtasks/OdometerTask.c
C_SOURCES += Ourtasks/odometer_items.c
C_SOURCES += Ourtasks/tim2tim5common_init.c
